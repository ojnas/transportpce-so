...
class TransportPCEFulltesting(unittest.TestCase):
    ...
    confd_container3 = None
    confd_container4 = None
    tpce_container = None
    client = docker.from_env()
    restconf_baseurl = "http://172.17.0.6:8181/restconf"
...
#START_IGNORE_XTESTING
    ...
    def __start_confd1(cls):
        cls.confd_container1 = cls.client.containers.run("confd-openroadm", "xpdra",
                                      init=True, detach=True, tty=True, remove=True)

    @classmethod
    def __start_confd2(cls):
        cls.confd_container2 = cls.client.containers.run("confd-openroadm", "xpdrc",
                                      init=True, detach=True, tty=True, remove=True)
                                      
    @classmethod
    def __start_confd3(cls):
        cls.confd_container3 = cls.client.containers.run("confd-openroadm", "roadma",
                                      init=True, detach=True, tty=True, remove=True)

    @classmethod
    def __start_confd4(cls):
        cls.confd_container4 = cls.client.containers.run("confd-openroadm", "roadmc",
                                      init=True, detach=True, tty=True, remove=True)
...
#  connect netconf devices
    ...
    def test_03_connect_rdmA(self):
        ...
        data = {"node": [{
             ...
             "netconf-node-topology:username": "admin",
             "netconf-node-topology:password": "admin",
             "netconf-node-topology:host": "172.17.0.4",
             "netconf-node-topology:port": "2022",
             "netconf-node-topology:tcp-only": "false",
             "netconf-node-topology:pass-through": {}}]}
        headers = {'content-type': 'application/json'}
    ...
    def test_04_connect_rdmC(self):
        ...
        data = {"node": [{
             ...
             "netconf-node-topology:username": "admin",
             "netconf-node-topology:password": "admin",
             "netconf-node-topology:host": "172.17.0.5",
             "netconf-node-topology:port": "2022",
             "netconf-node-topology:tcp-only": "false",
             "netconf-node-topology:pass-through": {}}]}
        headers = {'content-type': 'application/json'}
