...
#START_IGNORE_XTESTING
    ...
    def __start_confd3(cls):
        cls.confd_container3 = cls.client.containers.run("confd-openroadm", "roadmc",
                                      init=True, detach=True, tty=True, remove=True)

    @classmethod
    def __start_confd4(cls):
        cls.confd_container4 = cls.client.containers.run("confd-openroadm", "roadmb",
                                      init=True, detach=True, tty=True, remove=True)
    ...
    def tearDownClass(cls):
        ...
        with open('karaf_topology_log.tar', 'wb') as f:
            for chunk in bits:
                f.write(chunk)
