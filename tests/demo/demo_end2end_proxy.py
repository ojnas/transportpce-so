...
class TransportPCEFulltesting(unittest.TestCase):
    ...
    WAITING = 300 #20      #nominal value is 300
...
#  connect netconf devices
    ...
    def test_05_connect_xprdA_N1_to_roadmA_PP1(self):
        print("\ncreating link from XPDR-A1 to ROADM-A1 in network topology")
    ...
    def test_06_connect_roadmA_PP1_to_xpdrA_N1(self):
        print("\ncreating link from ROADM-A1 to XPDR-A1 in network topology")
    ...
    def test_07_connect_xprdC_N1_to_roadmC_PP1(self):
        print("\ncreating link from XPDR-C1 to ROADM-C1 in network topology")
        url = "{}/operations/transportpce-networkutils:init-xpdr-rdm-links".format(self.restconf_baseurl)
        data = {
            "networkutils:input": {
                "networkutils:links-input": {
    ...
    def test_08_connect_roadmC_PP1_to_xpdrC_N1(self):
        print("\ncreating link from ROADM-C1 to XPDR-C1 in network topology")
        url = "{}/operations/transportpce-networkutils:init-rdm-xpdr-links".format(self.restconf_baseurl)
        data = {
            "networkutils:input": {
                "networkutils:links-input": {
    ...
    def test_09_add_omsAttributes_ROADMA_ROADMC(self):
        ...
        print("\nadding OMS attributes to network topology for link from ROADM-A1 to ROADM-C1")
    ...
    def test_10_add_omsAttributes_ROADMC_ROADMA(self):
        ...
        print("\nadding OMS attributes to network topology for link from ROADM-C1 to ROADM-A1")
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
...
#test service-create for Eth service from xpdr to xpdr
    def test_11_create_eth_service1(self):
        print("\ncreating 100Gbps Ethernet service1 between XPDR-A1 and XPDR-C1")
    ...
    def test_12_get_eth_service1(self):
        print("\ngetting information about Ethernet service1")
    ...
    def test_13_check_xc1_ROADMA(self):
        print("\nchecking roadm-connections for ROADM-A1")
    ...
    def test_14_check_xc1_ROADMC(self):
        print("\nchecking roadm-connections for ROADM-C1")
        url = ("{}/config/network-topology:network-topology/topology/topology-netconf/"
    ...
    def test_15_check_topo_XPDRA(self):
        print("\nchecking XPDR-A1 termination points")
        ...
        for ele in liste_tp:
            if ele['tp-id'] == 'XPDR1-NETWORK1':
                self.assertEqual({u'frequency': 196.0,
                                  u'width': 92},
    ...
    def test_16_check_topo_ROADMA_SRG1(self):
        print("\nchecking available wavelengths on ROADM-A1 SRG1")
        ...
        for ele in liste_tp:
            if ele['tp-id'] == 'SRG1-PP1-TXRX':
                self.assertIn({u'index': 1, u'frequency': 196.0,
                               u'width': 92},
    ...
    def test_17_check_topo_ROADMA_DEG1(self):
        print("\nchecking available wavelengths on ROADM-A1 DEG2")
    ...
    def test_18_connect_xprdA_N2_to_roadmA_PP2(self):
        print("\ncreating link from second network interface of XPDR-A1 to ROADM-A1")
        url = "{}/operations/transportpce-networkutils:init-xpdr-rdm-links".format(self.restconf_baseurl)
        data = {
            "networkutils:input": {
                "networkutils:links-input": {
    ...
    def test_19_connect_roadmA_PP2_to_xpdrA_N2(self):
        print("\ncreating link from ROADM-A1 to second network interface of XPDR-A1")
        url = "{}/operations/transportpce-networkutils:init-rdm-xpdr-links".format(self.restconf_baseurl)
        data = {
            "networkutils:input": {
                "networkutils:links-input": {
    ...
    def test_20_connect_xprdC_N2_to_roadmC_PP2(self):
        print("\ncreating link from second network interface of XPDR-C1 to ROADM-C1")
        url = "{}/operations/transportpce-networkutils:init-xpdr-rdm-links".format(self.restconf_baseurl)
        data = {
            "networkutils:input": {
                "networkutils:links-input": {
    ...
    def test_21_connect_roadmC_PP2_to_xpdrC_N2(self):
        print("\ncreating link from ROADM-C1 to second network interface of XPDR-C1")
        url = "{}/operations/transportpce-networkutils:init-rdm-xpdr-links".format(self.restconf_baseurl)
        data = {
            "networkutils:input": {
                "networkutils:links-input": {
    ...
    def test_22_create_eth_service2(self):
        print("\ncreating 100Gbps Ethernet service2 between XPDR-A1 and XPDR-C1")
        url = ("{}/operations/org-openroadm-service:service-create"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_23_get_eth_service2(self):
        print("\ngetting information about Ethernet service2")
        ...
        for ele in liste_tp:
            if ele['tp-id'] == 'XPDR1-NETWORK1':
                self.assertEqual({u'frequency': 196.0,
                                  ...
                                  ele['org-openroadm-network-topology:xpdr-network-attributes']['wavelength'])
            if ele['tp-id'] == 'XPDR1-NETWORK2':
                self.assertEqual({u'frequency': 195.9,
                                  u'width': 92},
                                  ele['org-openroadm-network-topology:xpdr-network-attributes']['wavelength'])
        ...
        for ele in liste_tp:
            if ele['tp-id'] == 'SRG1-PP1-TXRX':
                self.assertIn({u'index': 1, u'frequency': 196.0,
                               u'width': 92},
                               ele['org-openroadm-network-topology:pp-attributes']['used-wavelength'])
                self.assertNotIn({u'index': 2, u'frequency': 195.9,
                                  u'width': 92},
                                  ele['org-openroadm-network-topology:pp-attributes']['used-wavelength'])
            if ele['tp-id'] == 'SRG1-PP2-TXRX':
                self.assertIn({u'index': 2, u'frequency': 195.9, u'width': 92},
                              ele['org-openroadm-network-topology:pp-attributes']['used-wavelength'])
                self.assertNotIn({u'index': 1, u'frequency': 196.0,
                                  u'width': 92},
                                  ele['org-openroadm-network-topology:pp-attributes']['used-wavelength'])
...
#     creation service test on a non-available resource
    def test_28_create_eth_service3(self):
        print("\ncreating 100Gbps Ethernet service3 between XPDR-A1 and XPDR-C1")
        url = ("{}/operations/org-openroadm-service:service-create"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
...
# add a test that check the openroadm-service-list still only contains 2 elements
    ...
    def test_29_delete_eth_service3(self):
        print("\ndeleting 100Gbps Ethernet service3")
    ...
    def test_30_delete_eth_service1(self):
        print("\ndeleting 100Gbps Ethernet service1")
        url = ("{}/operations/org-openroadm-service:service-delete"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_31_delete_eth_service2(self):
        print("\ndeleting 100Gbps Ethernet service2")
        url = ("{}/operations/org-openroadm-service:service-delete"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_32_check_no_xc_ROADMA(self):
        print("\nchecking that ROADM-A1 no longer has roadm-connections")
        url = ("{}/config/network-topology:network-topology/topology/topology-netconf/"
               "node/ROADM-A1/yang-ext:mount/org-openroadm-device:org-openroadm-device/"
               .format(self.restconf_baseurl))
        response = requests.request(
...
# test service-create for Optical Channel (OC) service from srg-pp to srg-pp
    def test_36_create_oc_service1(self):
        print("\ncreating Optical Channel service1 between ROADM-A1 and ROADM-C1")
        url = ("{}/operations/org-openroadm-service:service-create"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_37_get_oc_service1(self):
        print("\ngetting information about Optical channel service1")
        url = ("{}/operational/org-openroadm-service:service-list/services/service1"
              .format(self.restconf_baseurl))
        headers = {'content-type': 'application/json',
        "Accept": "application/json"}
    ...
    def test_40_create_oc_service2(self):
        print("\ncreating Optical Channel service2 between ROADM-A1 and ROADM-C1")
        url = ("{}/operations/org-openroadm-service:service-create"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_41_get_oc_service2(self):
        print("\ngetting information about Optical channel service2")
        url = ("{}/operational/org-openroadm-service:service-list/services/service2"
              .format(self.restconf_baseurl))
        headers = {'content-type': 'application/json',
        "Accept": "application/json"}
    ...
    def test_44_delete_oc_service1(self):
        print("\ndeleting Optical Channel service1")
        url = ("{}/operations/org-openroadm-service:service-delete"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_45_delete_oc_service2(self):
        print("\ndeleting Optical Channel service2")
        url = ("{}/operations/org-openroadm-service:service-delete"
              .format(self.restconf_baseurl))
        data = {"input": {
                "sdnc-request-header": {
    ...
    def test_46_get_no_oc_services(self):
        print("\nchecking that services no longer exist")
        #print ("start test")
